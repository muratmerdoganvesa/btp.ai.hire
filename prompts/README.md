...
Task types: `CvExtraction`, `SkillNormalization`, `JdCvMatching`, `InterviewQuestionGen`, `InterviewLiveTurn`, `InterviewEvaluation`, `RecruiterSummary`, `Embedding`, `CriteriaExtraction`.
